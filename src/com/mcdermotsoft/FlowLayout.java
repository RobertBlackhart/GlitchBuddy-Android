 ...
 * 
 *  Code found on the below URL with an unspecified license.
 *  
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE) {
                ...
                line_height = Math.max(line_height, child
                        .getMeasuredHeight()
                        + reflow_layout_params.vertical_spacing);
                ...
                xpos += childw
                        + reflow_layout_params.horizontal_spacing;
            }
        }
